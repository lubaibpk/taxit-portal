...
// ── Favicon: set the page icon & title to match Taxit brand ──
  useEffect(() => {
    ...
    link.rel = 'icon';
    link.type = 'image/svg+xml'; // SVG type for transparency and sharpness
    link.href = TAXIT_LOGO_URI;  // Points to /logo.svg
